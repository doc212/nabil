...
Nous pourrions générer les jeux aléatoirement mais les résultats seraient peu réalistes. En effet dans les jeux de données multicritères réalistes, nous retrouvons des corrélations: par exemple, la voiture la plus chère est souvent la plus rapide et la plus confortable.
