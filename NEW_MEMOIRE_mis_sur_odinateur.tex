...
L\textquotesingle aide à la décision est l\textquotesingle ensemble des techniques permettant, pour une personne don\-née, d\textquotesingle opter pour la meilleure prise de décision possible par rapport à certaines alternatives évaluées sur plusieurs critères.
...
\item L\textquotesingle analyse en composantes principales donne aussi une indication sur les dé\-pen\-dan\-ces mais elle ne donne aucune piste pour générer des valeurs.
...
\end{itemize}
  ...
  \item Apprentissage sur des données réalistes:
    ...
    Nous étudierons la légitimité des méthodes d'apprentissage décrites dans la deu\-xiè\-me section.
    Deux méthodes de bruitage agissant directement sur le jeu de données brut seront utilisées.
    Ceci permettra de tester la robustesse du réseau appris et de décorréler nos critères.

  \item Une section traitera la création des jeux de données générés à partir de réseaux bayésiens:

    A partir d'une modélisation,
    nous serons amenés à générer des données.
    On testera la vraisemblance des résultats par rapport à la modélisation mathématique de départ et le réalisme des données artificielless par rapport aux données réalistes.
...
Avant de passer au théorème fondamental qui va nous permettre d'interpréter les gra\-phes,
...
1our l'instant nous avons utilisé le théorème D-séparation pour a\-na\-ly\-ser les dé\-pla\-ce\-ments d'informations étant donné la connaissance de l'état $on/off$ d'un réseau, cependant  nous n'avons à aucun moment parlé de probabilité.
